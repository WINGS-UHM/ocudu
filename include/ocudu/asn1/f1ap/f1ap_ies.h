...
// E-CID-MeasurementQuantities ::= SEQUENCE (SIZE (1..64)) OF ProtocolIE-Field{F1AP-PROTOCOL-IES : IEsSetParam}
...
// PDCMeasurementQuantities ::= SEQUENCE (SIZE (1..16)) OF ProtocolIE-Field{F1AP-PROTOCOL-IES : IEsSetParam}
