...
// UE index formatter.
template <>
struct formatter<ocudu::ocuup::ue_index_t> {
  ...
  auto format(const ocudu::ocuup::ue_index_t& idx, FormatContext& ctx) const
  {
    if (idx == ocudu::ocuup::ue_index_t::INVALID_UE_INDEX) {
