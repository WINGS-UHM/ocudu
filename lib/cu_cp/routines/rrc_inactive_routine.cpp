...
#include "rrc_inactive_routine.h"
...
rrc_inactive_routine::rrc_inactive_routine(ue_index_t                             ue_index_,
...
void rrc_inactive_routine::operator()(coro_context<async_task<void>>& ctx)
{
  CORO_BEGIN(ctx);
