...
/// Section 3.4.8.
ocudu::fapi::crc_indication_message build_valid_crc_indication();
...
/// Section 3.4.2.
ocudu::fapi::dl_tti_request_message build_valid_dl_tti_request();

/// Builds and returns a valid ERROR.indication message. Every parameter is within the range defined in SCF-222 v4.0
/// Section 3.3.6.1.
ocudu::fapi::error_indication_message build_valid_error_indication();
...
ocudu::fapi::tx_data_request_message build_valid_tx_data_request();
...
/// Section 3.4.9.
ocudu::fapi::uci_indication_message build_valid_uci_indication();
...
/// Section 3.4.4.
ocudu::fapi::ul_dci_request_message build_valid_ul_dci_request();
...
/// Section 3.4.3.
ocudu::fapi::ul_tti_request_message build_valid_ul_tti_request();

/// Builds and returns a valid SRS.indication. Every parameter is within the range defined in SCF-222 v4.0
/// Section 3.4.10.
ocudu::fapi::srs_indication_message build_valid_srs_indication();
