...
const pucch_processor::format3_configuration base_format_3_config = {
    ...
    pucch_constants::f3::NOF_DATA_BITS.start(),
    // Number of SR bits.
    0,
    ...
    {{
     ...
     },
     {
         [] {
           test_params entry          = {};
           entry.config               = base_format_3_config;
           entry.config.nof_harq_ack  = pucch_constants::f3::NOF_DATA_BITS.start() - 1;
     ...
     },
     {
         [] {
           test_params entry               = {};
           entry.config                    = base_format_3_config;
           entry.config.nof_harq_ack       = pucch_constants::f3::NOF_DATA_BITS.stop();
